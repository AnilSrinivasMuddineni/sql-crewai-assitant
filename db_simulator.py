...
DB_PATH = "D:/Softwares/DB.Browser.for.SQLite-v3.13.1-win64/platforms/mydb.db"
...
if __name__ == "__main__":
    setup_sample_db()
    print(get_structured_schema("D:/Softwares/DB.Browser.for.SQLite-v3.13.1-win64/platforms/mydb.db"))
